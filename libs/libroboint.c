 ...
 * \example example.c
 *
 * \mainpage libroboint Index Page
 *
...
#define VERSION_MAJOR LIBROBOINT_VERSION_MAJOR
#define VERSION_MINOR LIBROBOINT_VERSION_MINOR
#define VERSION_PATCH LIBROBOINT_VERSION_PATCH
